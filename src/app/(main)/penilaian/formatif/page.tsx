...
import { Typography, Card, Table, Tag, Button, Input, Select, Space, Row, Col } from 'antd';
import { 
  SearchOutlined, 
  FilterOutlined, 
  EditOutlined, 
...
export default function PenilaianFormatifPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'studentsCount',
      render: (count: number) => <Tag color="blue">{count} Siswa</Tag>,
    },
    {
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <Button 
          ...
          size="small" 
          icon={<EditOutlined />} 
          className="bg-blue-600 shadow-sm text-xs h-7 px-3"
          onClick={() => router.push(`/penilaian/formatif/${record.id}`)}
        >
          Input Nilai
        </Button>
      ),
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 bg-slate-50 p-4 pt-2 relative">
      <div className="mb-2 text-gray-500 text-sm">Penilaian / Formatif</div>
